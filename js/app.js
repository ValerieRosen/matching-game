...
//Hides cards after 1 second if they do not match    
            ...
            if (openCards[0].dataset.card == openCards[1].dataset.card) {
                ...
                openCards[0].classList.add('open', 'disable');
                openCards[0].classList.add('show', 'disable');

                openCards[1].classList.add('match');
                openCards[1].classList.add('open', 'disable');
                openCards[1].classList.add('show', 'disable');
